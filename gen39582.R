...
rownames_39582 <- rownames(clinical_cleaned_39582)
...
run_bootstrap_validation_safe <- function(expr_mat, clinical_df, 
  ...
  for (b in 1:B) {
    ...
    selected_col <- colnames(clinical_df)[1:9]
...
res39582_j <- run_bootstrap_validation_safe(expr_mat, clinical_df, 
                                            B = 20, 
                                            seed = 8000000, 
                                            min_epv = 4, 
                                            coef_max = 10, 
...
saveRDS(res39582_j, file = "train_result_39582_j_best1_5132.rds")
...
res39582_riskscore <- run_bootstrap_validation_safe_riskscore(expr_mat, clinical_df, 
                                            B = 20, 
                                            seed = 9000010, 
                                            min_epv = 4, 
                                            coef_max = 10, 
...
#saveRDS(res39582_riskscore, "res39582_riskscore_1_562593.rds") 
...
res39582_clinical_2025_8_30 <- clinical_run_bootstrap_validation(clinical_df, 
                                            B = 20, 
                                            seed = 900000, 
                                           # min_epv = 4, 
                                            coef_max = 10, 
...
saveRDS(res39582_clinical_2025_8_30, file = "res39582_clinical_2025_8_30_1_5999.rds")
